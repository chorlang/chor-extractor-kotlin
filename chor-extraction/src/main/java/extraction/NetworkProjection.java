...
public class NetworkProjection {
    ...
    public NetworkProjection(SPNode sp) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
    ...
    private void project(HashMap<String, SPNode> network) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
