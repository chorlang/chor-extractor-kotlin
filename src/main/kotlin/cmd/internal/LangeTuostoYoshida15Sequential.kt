...
object LangeTuostoYoshida15Sequential {
    fun runningExample() = TestUtils.runSequentialExtractionTest(
    ...
    fun runningExample2x() = TestUtils.runSequentialExtractionTest(
    ...
    fun health() = TestUtils.runSequentialExtractionTest(
    ...
    fun health2x() = TestUtils.runSequentialExtractionTest(
                "hs{def X{p?; ss!<subscribed>; ss&{" +
                        "ok: p+subscribed; as!<account>; as?; t!<fwd>; t?; X, " +
                        "nok: p+notSubscribed; X}} main{X}} | " +
                        "p{def X{hs!<sendData>; hs&{subscribed: es?; X, notSubscribed: X}} main{X}} | " +
    ...
    fun filter() = TestUtils.runSequentialExtractionTest(
                "filter {" +
    ...
    fun filter2x() = TestUtils.runSequentialExtractionTest(
                "filter1 {" +
    ...
    fun logistic() = TestUtils.runSequentialExtractionTest(
                "supplier {" +
                        "def X {shipper?; Y} " +
                        "def Y {if needToShip " +
                        "then shipper+item; X " +
    ...
    fun logistic2x() = TestUtils.runSequentialExtractionTest(
                "supplier {" +
                        "def X {shipper?; Y} " +
                        "def Y {if needToShip " +
                        "then shipper+item; X " +
    ...
    fun logistic2() = TestUtils.runSequentialExtractionTest(
                "supplier {" +
    ...
    fun cloudSystem() = TestUtils.runSequentialExtractionTest(
                "cl{" +
    ...
    fun cloudSystem2x() = TestUtils.runSequentialExtractionTest(
                "cl{" +
                        "def X{int!<connect>; int?; Y} " +
                        "def Y{if access then appli+awaitcl; appli!<access>; Y else int!<logout>; appli+syncLogout; appli?; X} " +
                        "main {X}} | " +
    ...
    fun sanitaryAgency() = TestUtils.runSequentialExtractionTest(
                "citizen{" +
                        "def X{" +
    ...
    fun sanitaryAgency2x() = TestUtils.runSequentialExtractionTest(
                "citizen{" +
                        "def X{" +
                        "sanagency!<request>; sanagency?; sanagency!<provInf>; sanagency&{" +
                        "refusal: X, " +
