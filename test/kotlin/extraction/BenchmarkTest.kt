...
class BenchmarkTest {
    ...
    fun runningExample(strategyName: String, debugMode: Boolean) {
        ...
        when (strategy) {
            ...
            ExtractionStrategy.Random, ExtractionStrategy.UnmarkedThenRandom -> {
                /* value expected =
    ...
    fun runningExample2x(strategyName: String, debugMode: Boolean) {
        ...
        when (strategy) {
            ...
            ExtractionStrategy.ConditionsFirst -> {
            ...
            ExtractionStrategy.UnmarkedThenConditions -> {
                val expected =
            ...
            ExtractionStrategy.UnmarkedThenSelections -> {
                val expected =
...
//        println(actual)
        ...
        when (strategy) {
            ...
            ExtractionStrategy.LongestFirst -> {
    ...
    fun twoBit2x(strategyName: String, debugMode: Boolean) {
        ...
        when (strategy) {
            ...
            ExtractionStrategy.UnmarkedFirst, ExtractionStrategy.UnmarkedThenConditions, ExtractionStrategy.UnmarkedThenSelections -> {
                val expected =
