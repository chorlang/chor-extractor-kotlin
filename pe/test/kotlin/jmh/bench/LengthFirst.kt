...
open class LengthFirst{
    ...
    fun runningExample(){
        val test = "a {def X " +
                ...
                "{c?; a?; X} " +
                "main {X}}"
        Extraction.extractChoreography(test, ExtractionStrategy.LongestFirst).toString()
    }
    ...
    fun sanitaryAgency2x(){
        ...
        Extraction.extractChoreography(test, ExtractionStrategy.LongestFirst, ArrayList(listOf("coop","bank","coop2","bank2"))).toString()
    }
}