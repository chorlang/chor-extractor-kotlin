...
open class ConditionFirst{
    ...
    fun runningExample(){
        val test = "a {def X " +
                ...
                "d {def X " +
                    "{c?; a?; X} " +
                    "main {X}}"
        Extraction.extractChoreography(test, Strategy.ConditionFirst).toString()
    }
    ...
    fun bargain(){
        ...
        Extraction.extractChoreography(test, Strategy.ConditionFirst, ArrayList(listOf("c"))).toString()
    }
    ...
    fun bargain2x(){
        ...
        Extraction.extractChoreography(test, Strategy.ConditionFirst, ArrayList(listOf("c", "f"))).toString()
    }
    ...
    fun health(){
        ...
        Extraction.extractChoreography(test, Strategy.ConditionFirst, ArrayList(listOf("as", "t", "es"))).toString()
    }
    ...
    fun health2x(){
        ...
        Extraction.extractChoreography(test, Strategy.ConditionFirst, ArrayList(listOf("as1", "t1", "es1", "as2", "t2", "es2"))).toString()
    }
    ...
    fun logistic(){
        ...
        Extraction.extractChoreography(test, Strategy.ConditionFirst, ArrayList(listOf("retailer"))).toString()
    }
    ...
    fun cloudSystem(){
        ...
        Extraction.extractChoreography(test, Strategy.ConditionFirst, ArrayList(listOf("db","int"))).toString()
    }
    ...
    fun cloudSystem2x(){
        ...
        Extraction.extractChoreography(test, Strategy.ConditionFirst, ArrayList(listOf("db1","int1","db2","int2"))).toString()
    }
    ...
    fun sanitaryAgency(){
        ...
        Extraction.extractChoreography(test, Strategy.ConditionFirst, ArrayList(listOf("coop","bank"))).toString()
    }
    ...
    fun sanitaryAgency2x(){
        ...
        Extraction.extractChoreography(test, Strategy.ConditionFirst, ArrayList(listOf("coop","bank","coop2","bank2"))).toString()
    }
}