...
open class UnmarkedFirst {
    ...
    fun runningExample(){
        val test = "a {def X " +
                ...
                "{c?; a?; X} " +
                "main {X}}"
        Extraction.extractChoreography(test, Strategy.UnmarkedFirst).toString()
    }
    ...
    fun bargain(){
        ...
        Extraction.extractChoreography(test, Strategy.UnmarkedFirst, ArrayList(listOf("c"))).toString()
    }
    ...
    fun bargain2x(){
        ...
        Extraction.extractChoreography(test, Strategy.UnmarkedFirst, ArrayList(listOf("c", "f"))).toString()
    }
    ...
    fun health(){
        ...
        Extraction.extractChoreography(test, Strategy.UnmarkedFirst, ArrayList(listOf("as", "t", "es"))).toString()
    }
    ...
    fun health2x(){
        ...
        Extraction.extractChoreography(test, Strategy.UnmarkedFirst, ArrayList(listOf("as1", "t1", "es1", "as2", "t2", "es2"))).toString()
    }
    ...
    fun logistic(){
        ...
        Extraction.extractChoreography(test, Strategy.UnmarkedFirst, ArrayList(listOf("retailer"))).toString()
    }
    ...
    fun cloudSystem(){
        ...
        Extraction.extractChoreography(test, Strategy.UnmarkedFirst, ArrayList(listOf("db","int"))).toString()
    }
    ...
    fun cloudSystem2x(){
        ...
        Extraction.extractChoreography(test, Strategy.UnmarkedFirst, ArrayList(listOf("db1","int1","db2","int2"))).toString()
    }
    ...
    fun sanitaryAgency(){
        ...
        Extraction.extractChoreography(test, Strategy.UnmarkedFirst, ArrayList(listOf("coop","bank"))).toString()
    }
