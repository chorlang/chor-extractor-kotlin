...
open class UnmarkedThenRandom {
    ...
    fun runningExample(){
        val test = "a {def X " +
                ...
                "{c?; a?; X} " +
                "main {X}}"
        Extraction.extractChoreography(test, Strategy.UnmarkedThenRandom).toString()
    }
    ...
    fun sanitaryAgency2x(){
        ...
        Extraction.extractChoreography(test, Strategy.UnmarkedThenRandom, ArrayList(listOf("coop","bank","coop2","bank2"))).toString()
    }
}