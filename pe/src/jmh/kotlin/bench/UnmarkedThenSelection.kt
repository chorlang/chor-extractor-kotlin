...
open class UnmarkedThenSelection {
    ...
    fun runningExample(){
        val test = "a {def X " +
                ...
                "{c?; a?; X} " +
                "main {X}}"
        Extraction.extractChoreography(test, Strategy.UnmarkedThenSelection).toString()
    }
    ...
    fun sanitaryAgency2x(){
        ...
        Extraction.extractChoreography(test, Strategy.UnmarkedThenSelection, ArrayList(listOf("coop","bank","coop2","bank2"))).toString()
    }
}