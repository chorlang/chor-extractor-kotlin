...
open class SelectionFirst{
    ...
    fun runningExample(){
        val test = "a {def X " +
                ...
                "{c?; a?; X} " +
                "main {X}}"
        Extraction.extractChoreography(test, Strategy.SelectionsFirst).toString()
    }
    ...
    fun bargain(){
        ...
        Extraction.extractChoreography(test, Strategy.SelectionsFirst, ArrayList(listOf("c")))
    }
    ...
    fun bargain2x(){
        ...
        Extraction.extractChoreography(test, Strategy.SelectionsFirst, ArrayList(listOf("c", "f")))
    }
    ...
    fun health(){
        ...
        Extraction.extractChoreography(test, Strategy.SelectionsFirst, ArrayList(listOf("as", "t", "es")))
    }
    ...
    fun health2x(){
        ...
        Extraction.extractChoreography(test, Strategy.SelectionsFirst, ArrayList(listOf("as1", "t1", "es1", "as2", "t2", "es2")))
    }
    ...
    fun logistic(){
        ...
        Extraction.extractChoreography(test, Strategy.SelectionsFirst, ArrayList(listOf("retailer"))).toString()
    }
    ...
    fun cloudSystem(){
        ...
        Extraction.extractChoreography(test, Strategy.SelectionsFirst, ArrayList(listOf("db","int"))).toString()
    }
    ...
    fun cloudSystem2x(){
        ...
        Extraction.extractChoreography(test, Strategy.SelectionsFirst, ArrayList(listOf("db1","int1","db2","int2"))).toString()
    }
    ...
    fun sanitaryAgency(){
        ...
        Extraction.extractChoreography(test, Strategy.SelectionsFirst, ArrayList(listOf("coop","bank"))).toString()
    }
    ...
    fun sanitaryAgency2x(){
        ...
        Extraction.extractChoreography(test, Strategy.SelectionsFirst, ArrayList(listOf("coop","bank","coop2","bank2"))).toString()
    }
}